...
SamplingMeta::SamplingMeta(FFHandler handler,
  ...
  gpu_mem_allocator.create_legion_instance(reserveInst, totalSize, "SamplingMeta");
  ...
  gpu_mem_allocator.create_legion_instance(reserveInst, temp_storage_bytes, "SamplingMeta");
  d_temp_storage =
